...
label_4 = Label(root, text="AGE OF PATIENT", width=20, font=("bold", 9))
...
r1 = Radiobutton(root, text="male", padx=5, variable=var, value=1).place(x=235, y=255)
r2 = Radiobutton(root, text="female", padx=20, variable=var, value=2).place(x=300, y=255)

label_6 = Label(root, text=" COVID SYMPOTMS?", width=20, font=("bold", 9))
label_6.place(x=80, y=280)

Radiobutton(root, text="YES", padx=5, variable=Symptoms, value=1).place(x=235, y=280)
Radiobutton(root, text="NO", padx=20, variable=Symptoms, value=2).place(x=300, y=280)

label_7 = Label(root, text="COVID VACCINE?", width=20, font=("bold", 9))
label_7.place(x=80, y=305)

Radiobutton(root, text="YES", padx=5, variable=Vaccine, value=1).place(x=235, y=305)
Radiobutton(root, text="NO", padx=20, variable=Vaccine, value=2).place(x=300, y=305)

label_8 = Label(root, text="SELECT SLOT", width=20, font=("bold", 9))
...
label_9 = Label(root, text="SELECT CITY", width=20, font=("bold", 9))
