...
def menu():
    ...
    button2 = tkinter.Button(root1, text="2.ROOM ALLOCATION",command=func,bg='light green',fg='black')
    button3 = tkinter.Button(root1, text="3.EMPLOYEE REGISTRATION",bg='light blue',fg='black')
    button4 = tkinter.Button(root1, text="4.BOOK APPOINTMENT",bg='light green',fg='black')
