...
def menu():
    ...
    button2 = tkinter.Button(root1, text="2.VIEW APPOINTMENT(DATEWISE)",command=submit_searchd,bg='light green',fg='black')
    button3 = tkinter.Button(root1, text="3.EMPLOYEE REGISTRATION",command=reg,bg='light blue',fg='black')
    button4 = tkinter.Button(root1, text="4.DELETE APPOINTMENT",command=submitdel,bg='light green',fg='black')
